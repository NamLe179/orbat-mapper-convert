...
// Change: Remove .ts extension for Next.js compatibility
...
export interface NUnitAdd
  extends Optional<NUnit, "id" | "_pid" | "_gid" | "_sid"> {}
...
export interface ScenarioXYZLayerUpdate
  extends Partial<Omit<ScenarioXYZLayer, "id">> {}
export interface ScenarioKMLLayerUpdate
  extends Partial<Omit<ScenarioKMLLayer, "id">> {}
...
export interface SideGroupUpdate
  extends Partial<Omit<NSideGroup, "id" | "subUnits">> {}
export interface UnitUpdate extends Partial<Omit<NUnit, "id">> {}
export interface ScenarioEventUpdate
  extends Partial<Omit<NScenarioEvent, "id">> {}
...
export interface EquipmentDataUpdate
  extends Partial<Omit<NEquipmentData, "id">> {}
export interface PersonnelDataUpdate
  extends Partial<Omit<NPersonnelData, "id">> {}
export interface SupplyCategoryUpdate
  extends Partial<Omit<NSupplyCategory, "id">> {}
export interface SymbolFillColorUpdate
  extends Partial<Omit<NSymbolFillColor, "id">> {}
