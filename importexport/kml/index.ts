import { createFromString, getOneElement } from "@/importexport/milx/domutils";

/**
 * Parses a KML string or Blob URL into a DOM Document.
 * Note: This function depends on DOM APIs and must run on the client-side.
 */
